...
// CRIACAO DE PROMISE E O USO DO CATCH
...
// PROMISES COM O CATCH E O UNICO CATCH PARA TODAS AS REJEICOES
...
// ENCADEAMENTO DE THEN E O CATCH
...
// ENCADEAMENTO DE CATCHS DIRETAMENTE A PRIMEIRA PROMISE, OS DOIS SAO EXECUTADOS
...
// ENCADEAMENTO DE THENs E CATCHs COM EXCECAO NO MEIO DO FLUXO
...
.then( function acao2(res) { console.log(`${res} da acao 2`); return res})
.then( function acao3(res) { console.log(`${res} da acao 3`); return res})
.catch( function erro3(rej) { console.error('Tratamento das rejeicoes em P7 ou acao2 e acao3')});